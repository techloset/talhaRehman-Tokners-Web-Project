  ...
  return (
    <>
      <div className='bgBlur overflow-hidden xl:block sm:hidden xs:hidden'></div>
        <div className='grid grid-cols-12  2xl:ml-[10.813rem] lg:ml-20 xl:ml-20 sm:ml-14  overflow-x-hidden xs:m-0'>
          ...
          <h2 className='text-5xl font-bold leading-[54px] tracking-[-0.06rem] text-[#fff] 2xl:w-[97%] xl:w-[74%] mt-[0.625rem] xs:text-4xl xs:leading-[40px]'>Reimagining social media through the power of the blockchain.</h2>
