...
function Dashboard() {
  return (
    <>
    <div className='bgBlur overflow-hidden xl:block sm:hidden'></div>
      <div className='grid grid-cols-12  2xl:ml-[173px] lg:ml-16 xl:ml-20 sm:ml-[300px] overflow-x-hidden'>
        <div className='2xl:mt-[230px] xl:mt-[150px] lg:mt-[80px] sm:mt-[50px] 2xl:col-span-4 xl:col-span-6 lg:col-span-7 sm:col-span-12'>
          <h4 className='text-white'>At Tokners we are</h4>
          <h2 className='text-5xl font-bold leading-[54px] tracking-[-0.06rem] text-[#fff] 2xl:w-[97%] xl:w-[90%] mt-[10px]'>Reimagining social media through the power of the blockchain.</h2>
          <p className='mt-[30px] text-base font-normal leading-6 text-[#DDE2FF] opacity-60 w-[88%] font-[tokner] '>We are creating social media 3.0 with influencers, celebrities and creators being able to launch their own digital currency by simply creating a profile with media content posted as Non fungible Tokens that can be owned and traded on the Tknrs network</p>
        ...
        <div className='2xl:col-span-8 xl:col-span-6 lg:col-span-5 sm:col-span-12 xl:-ml-36 xl:-mt-20'>
          <img src={dashboard} alt="" className='xl:w-[100%] ' />
        </div>

      </div>
      {/* Section 2 Creators */}
      <div className='2xl:ml-[173px] flex sm:flex-wrap xl:flex-nowrap 2xl:mt-0 lg:mt-20 2xl:justify-start sm:justify-center  '>
        <div className='bg-[#171B29] 2xl:w-[777px] xl:w-[45%] 2xl:h-[436px] xl:h-auto rounded-[25px] lg:w-[80%] 2xl:pb-0 lg:pb-10'>
          <div className='ml-[70px]'>
            ...
            <p className='mt-5 text-base font-normal leading-6 opacity-50  text-[#FFFFFF] w-[90%] font-[tokner]'>Creators can gain independence through a decentralised digital currency system that is
        ...
        <div className='bg-[#171B29] 2xl:w-[777px] 2xl:h-[436px] xl:w-[45%] lg:w-[80%] xl:h-auto ml-5 mt-[73px] rounded-[25px] 2xl:pb-0  lg:pb-10'>
          <div className='ml-[70px]'>
            ...
            <p className='mt-5 text-base font-normal leading-6 opacity-50  text-[#FFFFFF] w-[89%] font-[tokner]'>Holding social tokens allows the individual to gain access to benefits including unreleased
      ...
      <div className='mt-[120px] grid 2xl:grid-cols-2 sm:grid-cols-1'>
        <div className='lg:hidden 2xl:block '><img src={colorfull} alt="" className='w-full' /></div>
        <div className='bg-[#fff] lg:rounded-tl-[400px] sm:rounded-tr-[400px] lg:rounded-tr-none 2xl:pb-3 lg:pb-10'>
          <div className='ml-[143px] mt-[296px]'>
            ...
            <p className='mt-[30px] text-base font-normal leading-6 opacity-60 text-[#0F1320] w-[71%] font-[tokner]'>There are several thousand celebrities and creators on twitter, tiktok, Instagram and YouTube with followings in the millions who we would be actively engaging before we go viral.
              <br />
              <br />
              <br />
      ...
      {/* Section 4 History */}
      <div className='mt-[203px] 2xl:ml-[173px] 2xl:mr-[188px] '>
        <div className='flex sm:flex-wrap sm:justify-center 2xl:justify-normal'>
          <div>
            ...
            <div className='mt-[39px] w-[365px]'>
              <p><span className='text-xs font-bold leading-[34px] text-[#22A75D] mr-5'>01</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Team set-up</span></p>
              <p><span className='text-xs font-bold leading-[34px] text-[#22A75D] mr-5'>02</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Launch of informational website</span></p>
            </div>
          </div>
          ...
          <div className='ml-[31px]'>
            ...
            <div className='mt-[39px] leading-[34px] w-[375px]'>
              <p><span className='text-xs font-bold leading-[34px] text-[#2278D4] mr-5'>01</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Presale and exchange listings</span></p>
              <p><span className='text-xs font-bold leading-[34px] text-[#2278D4] mr-5'>02</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Blockchain development and launch</span></p>
              <p><span className='text-xs font-bold leading-[34px] text-[#2278D4] mr-5'>03</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Launch of our MVP</span></p>
              <p><span className='text-xs font-bold leading-[34px] text-[#2278D4] mr-5'>04</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Influencer agency partnerships</span></p>
              <p><span className='text-xs font-bold leading-[34px] text-[#2278D4] mr-5'>05</span> <span className='text-[#fff] text-lg font-normal leading-[34px] opacity-70 font-[tokner]'> Marketing and promotion </span></p>
            </div>
          </div>
          ...
          <div className='ml-[24px]'>
            ...
            <div className='mt-[39px] w-[338px]'>
              <div className='flex '>
                <p><span className='text-xs font-bold leading-[34px] text-[#FFD100] mr-5'>01</span> </p>
              ...
              <div className='flex mt-2'>
                <p><span className='text-xs font-bold leading-[34px] text-[#FFD100] mr-5'>02</span> </p>
              ...
              <div className='flex mt-2'>
                <p><span className='text-xs font-bold leading-[34px] text-[#FFD100] mr-5'>03</span> </p>
          ...
          <div className='ml-[61px]'>
            ...
            <div className='mt-[39px] w-[338px]'>
              ...
              <div className='flex'>
                <p><span className='text-xs font-bold leading-[34px] text-[#E20613] mr-5'>04</span> </p>
      ...
      <div className='2xl:mx-[173px] xl:mx-10 lg:mx-12 mt-[189px] '>
        <div className='flex xl:flex-nowrap sm:flex-wrap 2xl:justify-normal sm:justify-center '>
          <div className='2xl:w-[644px] xl:w-[45%] sm:order-2 xl:order-1'>
            <div className='flex flex-nowrap xl:justify-normal sm:justify-center'>
              <img src={logoicom} alt="" className='sm:self-end xl:self-auto' />
              <h2 className='text-5xl font-bold text-[#fff] ml-6 xl:mt-0 sm:mt-20'>Tokner is coming</h2>
            </div>
            <div className='xl:mx-0 xl:w-[100%] sm:w-[90%] sm:mx-auto' >

              <p className='text-[#fff] text-base font-bold leading-6 w-[95%] mt-[30px] opacity-60'>Cryptocurrency adoption is at less than 1% of the global world population with some countries and entities actively fighting against its mass adoption and the smartest developers and nerds holding the fort.</p>
              <p className='text-[#fff] text-base font-normal leading-6 opacity-60 mt-5 w-[97%] font-[tokner]'> Bitcoin was the first, and it has since grown to thousands of tokens launched all aiming to fix one problem or the other with some quite simply FOMOing the moment. Our goal is to bring mass adoption to the cryptocurrency space by dumbing it down. How far down? So down that even a celebrity can explain it in simple words to their followers and have them download an app, buy into the social currency of their favourite person and watch their investment as is with other crypto currency project.
            ...
            <div className='mt-5 xl:mx-0 xl:w-[100%] sm:w-[90%] sm:mx-auto '><button className='text-sm font-bold leading-normal text-[#fff] border-2 border-[#22A75D] rounded-[52px] w-[147px] h-12'>Read More</button></div>


          </div>
          <div className=' relative sm:order-1 xl:order-2'>
      ...
      {/* section 6 PreSAle */}
      <div className='bgpresale pb-[160px]'>
        <div className='mx-[173px] pt-[450px]'>
      ...
      <div className='mx-[173px]'>
        ...
        <div className='flex'>
          <div className='w-[511px] h-[270px] bg-[#171B29] rounded-[25px] relative mt-[50px] '>
            <span className='text-xs font-bold leading-6 opacity-30 text-[#fff] ml-[30px] pt-[30px] block'>01</span>
            <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px]'><p className='w-[52%]'>First Connect your Metamask or TrustWallet to the "Connect Wallet" on the Homepage.</p></div>
            <div className='h-[86px] w-[86px] rounded-full bg-[#0F1320] flex justify-center items-center absolute top-[43%] left-[90%] z-50'><div><img src={cr} alt="" /></div></div>
          </div>

          <div className='w-[511px] h-[270px] bg-[#171B29] rounded-[25px] relative ml-5 mt-[110px]'>
            <span className='text-xs font-bold leading-6 opacity-30 text-[#fff] ml-[30px] pt-[30px] block'>02</span>
            <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px]'><p className='w-[50%]'>Then send minimum of 0.1 BNB or maximum of 10 BNB to the Presale wallet</p></div>
            <div className='h-[86px] w-[86px] rounded-full bg-[#0F1320] flex justify-center items-center absolute top-[20%] left-[90%] z-50'><div><img src={cr1} alt="" /></div></div>
          </div>
          <div className='w-[511px] h-[270px] bg-[#171B29] rounded-[25px] relative ml-5 mt-[50px]'>
            <span className='text-xs font-bold leading-6 opacity-30 text-[#fff] ml-[30px] pt-[30px] block'>03</span>
            <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px]'><p className='w-[50%]'>Then after you will received your $WNTR to your address within 24hours. </p></div>
          </div>
        </div>
      </div>
