        ...
        <div className='flex xl:flex-nowrap sm:flex-wrap xs:flex-wrap 2xl:justify-normal sm:justify-center '>
          <div className='2xl:w-[644px] xl:w-[45%] sm:order-2 xs:order-2 xl:order-1 xs:mt-[70px]'>
            ...
            <div className='xl:mx-0 xl:w-[100%] sm:w-[90%] sm:mx-auto xs:mx-5' >
              ...
              {isShowMore && (<p> <p className='text-[#fff] text-base font-normal leading-6 opacity-60 mt-5 w-[97%] font-[tokner] xs:text-sm xs:w-[99%]'>  We are trying to do to this space what investment apps did for the "nonexistent retail investors". We are gamefying digital currency, bringing in popular faces instead of hard to understand projects to make it the norm and inadvertently being the "gateway drug" for a lot of people to finally give this space a real look.</p>
            ...
            <div className='mt-5 xl:mx-0 xl:w-[100%] sm:w-[90%] sm:mx-auto xs:hidden '><button className='text-sm font-bold leading-normal text-[#fff] border-2 border-[#22A75D] rounded-[52px] w-[147px] h-12'  > {isShowMore ? "Read Less" : "Read More"}</button></div>
            <div className='hidden xs:block xs:mx-5'> <button className='text-lg font-bold text-[#22A75D] mt-1 border-[#22A75D] border-dotted border-b-2' onClick={toggleReadMoreLess}>{isShowMore ? "Read Less" : "Read More"}</button></div>
